...
class app_paises():
    ...
    def __init__(self) -> None:
        self.dfpaises: pd.core.frame.DataFrame = None
    ...
    def MainPage(self):
        ...
        #..... Gráfico-2: histograma - qty de cidades por país
        st.markdown("""---""")
        with st.container():
        ...
        #                     h.1 - média de avaliações feitas por país
        #                     h.2 - média de preço do prato p/2 por país
        st.markdown("""---""")
        with st.container():
